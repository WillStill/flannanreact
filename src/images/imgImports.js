...
const data = [
{img: _BronaCleit,
 name: "BronaCleit", folder: "."},
{img: _Cove,
 name: "Cove", folder: "."},
{img: _EileanGhobha,
 name: "EileanGhobha", folder: "."},
{img: _EileanGhobhaandRoareim,
 name: "EileanGhobhaandRoareim", folder: "."},
{img: _EileanMor,
 name: "EileanMor", folder: "."},
{img: _EileanMorTip,
 name: "EileanMorTip", folder: "."},
{img: _EileanTaighe,
 name: "EileanTaighe", folder: "."},
{img: _Eilean_a_Ghobha_and_Roareim,
 name: "Eilean_a_Ghobha_and_Roareim", folder: "."},
{img: _FlannanMap,
 name: "FlannanMap", folder: "."},
{img: _OldShieling,
 name: "OldShieling", folder: "."},
{img: _Path,
 name: "Path", folder: "."},
{img: _Roaireim,
 name: "Roaireim", folder: "."},
{img: _RoundingBronaCleit,
 name: "RoundingBronaCleit", folder: "."},
{img: _SgeirTomain,
 name: "SgeirTomain", folder: "."},
{img: _Soraidh,
 name: "Soraidh", folder: "."},
{img: _SoraidhWater,
 name: "SoraidhWater", folder: "."},
